...
const SENDER_DOMAIN = "notify.serp.aiseocore.com"
const ROOT_DOMAIN = "serp.aiseocore.com"
const FROM_DOMAIN = "serp.aiseocore.com"

// Sample data for preview mode ONLY
const SAMPLE_PROJECT_URL = "https://serp.aiseocore.com"
...
// Webhook handler - verifies signature and sends email via Lovable Email API
async function handleWebhook(req: Request): Promise<Response> {
  ...
  try {
    ...
    console.error('Failed to send email via Lovable API', { error: sendError, run_id, emailType })
